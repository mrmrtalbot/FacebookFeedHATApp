 ...
 while ($feednumber < $number_of_feed_items)
  {
    ...
    /*while ($WithFacebooknumber < $number_of_With_Names)
      ...
      */
      ...
      {
        $feedstart = $graphObject['feed']->data[$feednumber]->created_time;
      }
      ...
      else
      {
        ...
        //$FacebookAccountName = preg_split('/\s+/', $people);
        //$FeedMessageFromName = preg_split('/\s+/', $people);
        //$ToFacebookAccountName = preg_split('/\s+/', $people);
        //$WithFacebookAccountName = preg_split('/\s+/', $people);
        //$StoryTagsName = preg_split('/\s+/', $people);
        //echo $fullName[0];
        //echo "<br />";
        //echo $fullName[1];
